...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "semantic_projection_node = my_py_pkg.semantic_projection_node:main",
            "slam_semantic_map_viewer = my_py_pkg.slam_semantic_map_viewer:main",
            "slam_semantic_rviz_node = my_py_pkg.slam_semantic_rviz_node:main",
        ],
    },
)
