#!/usr/bin/env python3
"""Run semantic_05 with MobileSAM masks and dense RGB object point clouds."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    defaults = {
        ...
        "yolo_output_dir": "/tmp/semantic_05_sam_yolo",
        ...
        "bag_delay_s": "5.0",
        "enable_rviz": "true",
        "rviz_config": str(offline_share / "config" / "semantic_mapping_debug.rviz"),
    ...
    yolo = Node(
        ...
        name="semantic_05_sam_yolo_world",
        output="screen",
    ...
    projection = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            str(offline_share / "launch" / "sam_offline_projection.launch.py")
        ),
        launch_arguments={
            "use_sim_time": "true",
