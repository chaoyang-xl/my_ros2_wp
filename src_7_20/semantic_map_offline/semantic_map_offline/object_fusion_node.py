...
from semantic_map_offline.object_map_io import object_record, write_semantic_object_map
from semantic_map_offline.offline_projector_node import (
    pack_rgb_uint32,
    unpack_rgb_uint32,
)
...
class ObjectFusionNode(Node):
    ...
    def __init__(self) -> None:
        super().__init__("semantic_map_offline_fusion")
        defaults = {
    ...
    def _write_object_snapshot(self, frame_id: str, tracks: list, arrays: dict) -> dict:
        ...
        if json_path is not None:
            return write_semantic_object_map(
                ...
                source="semantic_map_offline_ros",
                metadata={"output_directory": str(output_root)},
            )
        return {
            "schema_version": 1, "frame_id": frame_id,
            "count": len(records), "source": "semantic_map_offline_ros",
            "objects": records,
        }
