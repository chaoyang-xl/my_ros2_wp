...
from semantic_map_offline.bbox_projection import (
    CameraIntrinsics,
    image_size_from_payload,
    project_bbox_depth,
    transform_points,
)
from semantic_map_offline.spatial_filter import largest_spatial_cluster_indices
...
class OfflineProjectorNode(Node):
    ...
    def __init__(self, node_name: str = "semantic_map_offline_projector") -> None:
