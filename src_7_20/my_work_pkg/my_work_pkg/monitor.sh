#!/usr/bin/env bash
# Orange Pi 5 Plus / RK3588 runtime monitor.
# Usage: sudo bash monitor.sh [--interval SECONDS] [--once]
...
usage() {
  cat <<'EOF'
Usage: monitor.sh [--interval SECONDS] [--once] [--no-clear] [--help]
...
while true; do
  ...
  echo "============================================================"
  printf " Orange Pi 5 Plus / RK3588   %s   uptime: %s\n" \
